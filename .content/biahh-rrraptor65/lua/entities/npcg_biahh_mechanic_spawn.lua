...
if SERVER then
	function ENT:Initialize()
		...
		if	GetConVarNumber("npcg_biahh_mechanic_squad") >= 4	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_PERFECT)
		elseif	GetConVarNumber("npcg_biahh_mechanic_squad") == 3	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_VERY_GOOD)
		elseif	GetConVarNumber("npcg_biahh_mechanic_squad") == 2	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_GOOD)
		elseif	GetConVarNumber("npcg_biahh_mechanic_squad") == 1	then
