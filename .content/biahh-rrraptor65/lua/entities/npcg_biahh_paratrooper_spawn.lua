...
if SERVER then
	function ENT:Initialize()
		...
		self.ent1:SetModel("models/jessev92/biahh/characters/bia3_npccit.mdl" )
		...
		if	GetConVarNumber("npcg_biahh_paratrooper_squad") >= 4	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_PERFECT)
		elseif	GetConVarNumber("npcg_biahh_paratrooper_squad") == 3	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_VERY_GOOD)
		elseif	GetConVarNumber("npcg_biahh_paratrooper_squad") == 2	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_GOOD)
		elseif	GetConVarNumber("npcg_biahh_paratrooper_squad") == 1	then
	...
	function ENT:Think()
		...
		if	GetConVarNumber("npcg_biahh_paratrooper_accuracy") >= 4	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_PERFECT)
		elseif	GetConVarNumber("npcg_biahh_paratrooper_accuracy") == 3	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_VERY_GOOD)
		elseif	GetConVarNumber("npcg_biahh_paratrooper_accuracy") == 2	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_GOOD)
		elseif	GetConVarNumber("npcg_biahh_paratrooper_accuracy") == 1	then
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_AVERAGE)
		else
			self.ent1:SetCurrentWeaponProficiency(WEAPON_PROFICIENCY_POOR)
		end
